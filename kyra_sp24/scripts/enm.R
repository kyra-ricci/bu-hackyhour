...
library(devtools)
install_github("cran/rgdal", dependencies = TRUE)
pkgbuild::check_build_tools(debug = TRUE)
library(rgdals)

install_github("rmcelreath/rethinking", dependencies = TRUE)

1# Read in the file with your occurrence data that has been formatted for "spThin"
...
thin(
  ...
  write.files = TRUE, 
  max.files = 10, 
  out.dir = "data/", out.base = "calycinus", 
  write.log.file = TRUE,
  log.file =  "calycinus.txt"
